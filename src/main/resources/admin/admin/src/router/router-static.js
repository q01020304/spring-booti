...
import jiazhangxueyuan from '@/views/modules/jiazhangxueyuan/list'
import baomingjiaofei from '@/views/modules/baomingjiaofei/list'
import chengzhangpingjia from '@/views/modules/chengzhangpingjia/list'
import kaoshi from '@/views/modules/kaoshi/list'
import yuebao from '@/views/modules/yuebao/list'
...
export const routes = [{
    ...
    children: [{
        ...
        ,{
            path: '/jiazhangxueyuan',
            name: '家长绑定学员',
            component: jiazhangxueyuan
        }
        ,{
            path: '/baomingjiaofei',
            name: '报名缴费',
        ...
        ,{
            path: '/chengzhangpingjia',
            name: '成长评价',
            component: chengzhangpingjia
        }
        ,{
            path: '/kaoshi',
            name: '考试情况',
