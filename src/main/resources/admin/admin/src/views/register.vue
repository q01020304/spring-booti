	...
	<div>
		<div class="container" :style='{"minHeight":"auto","padding":"20px  200px 20px 0","background-attachment":"fixed","background":"url(http://codegen.caihongy.cn/20240220/b7c1c0cd08d847ecb5e7145e3cdc43ae.jpg) no-repeat  center top / cover,#f9fbfd","display":"flex","width":"100%","justifyContent":"flex-end"}'>
			<el-form v-if="pageFlag=='register'" :style='{"padding":"40px 20px","margin":"0","borderRadius":"10px","flexWrap":"wrap","background":"rgba(106, 171, 156)","display":"flex","width":"450px"}' ref="rgsForm" class="rgs-form" :model="rgsForm" :rules="rules">
				<div v-if="true" :style='{"width":"100%","margin":"0 auto 20px auto","lineHeight":"44px","fontSize":"20px","color":"#fff","textAlign":"center"}' class="title">起点树艺术培训机构系统注册</div>
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 2px","height":"auto"}' class="list-item" v-if="tableName=='xueyuan'">
				...
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 2px","height":"auto"}' class="list-item" v-if="tableName=='xueyuan'">
					<div v-if="true" :style='{"width":"100%","lineHeight":"44px","fontSize":"14px","position":"relative","color":"#fff"}' class="lable" :class="changeRules('xueyuanxingming')?'required':''">学员姓名：</div>
				...
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 2px","height":"auto"}' class="list-item" v-if="tableName=='xueyuan'">
					<div v-if="true" :style='{"width":"100%","lineHeight":"44px","fontSize":"14px","position":"relative","color":"#fff"}' class="lable" :class="changeRules('xueyuanshouji')?'required':''">学员手机：</div>
					<el-input  v-model="ruleForm.xueyuanshouji"  autocomplete="off" placeholder="学员手机"  type="text"  />
				</el-form-item>
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 2px","height":"auto"}' class="list-item" v-if="tableName=='xueyuan'">
					<div v-if="true" :style='{"width":"100%","lineHeight":"44px","fontSize":"14px","position":"relative","color":"#fff"}' class="lable" :class="changeRules('banji')?'required':''">班级：</div>
                    <el-select v-model="ruleForm.banji" placeholder="请选择班级" :disabled="true">
                        <el-option
				...
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 2px","height":"auto"}' class="list-item" v-if="tableName=='jiaoshi'">
					<div v-if="true" :style='{"width":"100%","lineHeight":"44px","fontSize":"14px","position":"relative","color":"#fff"}' class="lable" :class="changeRules('jiaoshigonghao')?'required':''">教师工号：</div>
				...
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 2px","height":"auto"}' class="list-item" v-if="tableName=='jiaoshi'">
					<div v-if="true" :style='{"width":"100%","lineHeight":"44px","fontSize":"14px","position":"relative","color":"#fff"}' class="lable" :class="changeRules('zhicheng')?'required':''">职称：</div>
				...
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 2px","height":"auto"}' class="list-item" v-if="tableName=='jiaoshi'">
					<div v-if="true" :style='{"width":"100%","lineHeight":"44px","fontSize":"14px","position":"relative","color":"#fff"}' class="lable" :class="changeRules('lianxidianhua')?'required':''">联系电话：</div>
		...
		login() {
            ...
            if(this.ruleForm.touxiang!=null) {
                this.ruleForm.touxiang = this.ruleForm.touxiang.replace(new RegExp(this.$base.url,"g"),"");
					...
					if(`xueyuan` == this.tableName && this.ruleForm.xueyuanshouji &&(!this.$validate.isMobile(this.ruleForm.xueyuanshouji))){
