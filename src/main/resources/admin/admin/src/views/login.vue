<template>
  <div>
    <div class="container" :style='{"minHeight":"100vh","padding":"20px  400px 20px 0","alignItems":"center","background-attachment":"fixed","background":"url(http://codegen.caihongy.cn/20240220/b7c1c0cd08d847ecb5e7145e3cdc43ae.jpg) no-repeat  center top / 100% 100%,#f9fbfd","display":"flex","width":"100%","justifyContent":"flex-end"}'>
      <el-form :style='{"padding":"40px 20px","margin":"0","borderRadius":"8px","flexWrap":"wrap","background":"rgba(106, 171, 156)","display":"flex","width":"450px"}'>
        <div v-if="true" :style='{"padding":"40px 0","margin":"0 auto 20px auto","borderColor":"#fff","color":"#fff","textAlign":"center","borderWidth":"0 0 1px 0","width":"80%","lineHeight":"44px","fontSize":"28px","borderStyle":"solid"}' class="title-container">起点树艺术培训机构系统登录</div>
        ...
        <div :style='{"padding":"0 16px","margin":"0 auto","alignItems":"center","flexWrap":"wrap","display":"flex"}'>
          ...
          <el-button :style='{"cursor":"pointer","padding":"0 24px","margin":"0 10px","outline":"none","color":"rgb(106, 171, 156)","borderRadius":"4px","background":"#fff","width":"auto","letterSpacing":"1px","fontSize":"14px","height":"44px"}' type="primary" @click="register('jiaoshi')" class="register">注册教师</el-button>
        </div>
      </el-form>
