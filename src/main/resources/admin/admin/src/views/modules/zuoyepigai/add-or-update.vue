	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="作业成绩" prop="zuoyechengji">
					<el-input-number v-model="ruleForm.zuoyechengji" placeholder="作业成绩" :readonly="ro.zuoyechengji"></el-input-number>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="作业成绩" prop="zuoyechengji">
					<el-input v-model="ruleForm.zuoyechengji" placeholder="作业成绩" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="批改时间" prop="pigaishijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.pigaishijian" 
						type="datetime"
						:readonly="ro.pigaishijian"
						placeholder="批改时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.pigaishijian" label="批改时间" prop="pigaishijian">
					<el-input v-model="ruleForm.pigaishijian" placeholder="批改时间" readonly></el-input>
				</el-form-item>
			</template>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.pingyu" label="评语" prop="pingyu">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.pingyu}}</span>
				</el-form-item>
