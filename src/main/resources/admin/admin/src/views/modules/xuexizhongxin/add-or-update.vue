		...
		init(id,type) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					if(((json.xueyuanxingming!=''&&json.xueyuanxingming) || json.xueyuanxingming==0) && this.$storage.get("role")!="管理员"){
						this.ruleForm.xueyuanxingming = json.xueyuanxingming
						this.ro.xueyuanxingming = true;
					}
					if(((json.xueyuanshouji!=''&&json.xueyuanshouji) || json.xueyuanshouji==0) && this.$storage.get("role")!="管理员"){
