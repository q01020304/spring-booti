	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="班级描述" prop="banjimiaoshu">
					<el-input v-model="ruleForm.banjimiaoshu" placeholder="班级描述" clearable  :readonly="ro.banjimiaoshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="班级描述" prop="banjimiaoshu">
					<el-input v-model="ruleForm.banjimiaoshu" placeholder="班级描述" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'" label="教师工号" prop="jiaoshigonghao">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.jiaoshigonghao" label="教师工号" prop="jiaoshigonghao">
					<el-input v-model="ruleForm.jiaoshigonghao" placeholder="教师工号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="班级老师" prop="jiaoshixingming">
					<el-input v-model="ruleForm.jiaoshixingming" placeholder="班级老师" clearable  :readonly="ro.jiaoshixingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="班级老师" prop="jiaoshixingming">
					<el-input v-model="ruleForm.jiaoshixingming" placeholder="班级老师" readonly></el-input>
				</el-form-item>
	...
	data() {
		...
		return {
			...
			rules: {
				...
				jiaoshixingming: [
					{ required: true, message: '班级老师不能为空', trigger: 'blur' },
				],
				lianxidianhua: [
				],
			}
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='banjimiaoshu'){
							this.ruleForm.banjimiaoshu = obj[o];
							this.ro.banjimiaoshu = true;
							continue;
						}
						if(o=='jiaoshigonghao'){
