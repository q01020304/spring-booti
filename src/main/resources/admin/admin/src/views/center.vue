<template>
  <div :style='{"padding":"20px 30px","background":"#f9fbfd","flexDirection":"column","display":"flex"}'>
    ...
    >  
     <el-row>
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='xueyuan'"  label="学号" prop="xuehao">
          <el-input v-model="ruleForm.xuehao" readonly              placeholder="学号" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='xueyuan'"  label="学员姓名" prop="xueyuanxingming">
          <el-input v-model="ruleForm.xueyuanxingming"               placeholder="学员姓名" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}' v-if="flag=='xueyuan'"  label="性别" prop="xingbie">
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}' v-if="flag=='xueyuan'" label="头像" prop="touxiang">
          <file-upload
          tip="点击上传头像"
          action="file/upload"
          :limit="3"
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='xueyuan'"  label="学员手机" prop="xueyuanshouji">
          <el-input v-model="ruleForm.xueyuanshouji"               placeholder="学员手机" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}' v-if="flag=='xueyuan'"  label="班级" prop="banji">
