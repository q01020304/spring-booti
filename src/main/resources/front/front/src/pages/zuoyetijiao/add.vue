...
<div :style='{"width":"1200px","padding":"20px","margin":"10px auto 20px","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"50%","padding":"10px","margin":"0 0 10px","background":"#fff"}' label="提交作业" prop="tijiaozuoye">
            <file-upload
            tip="点击上传提交作业"
            action="file/upload"
            :limit="1"
          ...
          <el-form-item :style='{"width":"50%","padding":"10px","margin":"0 0 10px","background":"#fff"}' label="提交时间" prop="tijiaoshijian">
              <el-date-picker
          ...
          <el-form-item :style='{"width":"50%","padding":"10px","margin":"0 0 10px","background":"#fff"}'  label="批改状态" prop="pigaizhuangtai">
  ...
  export default {
    ...
    // 多级联动参数
      ...
      tijiaozuoyeUploadChange(fileUrls) {
          this.ruleForm.tijiaozuoye = fileUrls.replace(new RegExp(this.$config.baseUrl,"g"),"");;
      },
    }
  };
</script>
