<template>
  <div :style='{"width":"86%","padding":"20px","margin":"20px auto","position":"relative","background":"rgb(255, 255, 255)"}'>
    <div :style='{"width":"100%"}'>
		<div :style='{"padding":"0 10px","color":"#000","textAlign":"center","width":"100%","lineHeight":"54px","fontSize":"30px","height":"54px"}'>论坛交流</div>
	</div>
    ...
    <div class="section-content" :style='{"border":"1px solid #D8D8D8","width":"100%","margin":"20px auto","position":"relative","background":"rgb(255, 255, 255)"}'>
      <div class="content-title" :style='{"width":"100%","padding":"10px","lineHeight":"32px","fontSize":"18px","color":"#000","textAlign":"center"}'>{{detail.title}}</div>
      ...
      <div :style='{"padding":"20px"}' class="content-detail" v-html="detail.content"></div>
		...
		<div :style='{"width":"100%","padding":"20px"}'>
			...
			<div class="comment" :style='{"width":"100%"}'>
				...
				<div class="item" :style='{"border":"1px solid #D8D8D8","padding":"10px","margin":"20px 0 0 0","alignItems":"center","color":"#666","background":"#fff","width":"100%","height":"auto"}' v-for="item in commentList" :key="item.id" @mouseenter="commentEnter(item.id)" @mouseleave="commentLeave">
					...
					<div :style='{"padding":"8px","margin":"10px 0px 0px","lineHeight":"30px","fontSize":"14px","color":"#9E9E9E","borderRadius":"4px"}' v-html="item.content"></div>
					<div class="btn" :style='{"width":"100%","margin":"8px 0 0 0","alignItems":"center","justifyContent":"flex-end","display":"flex","height":"40px"}'>
						<el-button :style='{"border":"0","cursor":"pointer","padding":"0 20px","margin":"0 10px","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"4px","background":"#769589","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="showIndex==item.id&&showIndex1 == -1" @click="replyClick(item.id)">回复</el-button>
						<el-button :style='{"border":"1px solid #769589","cursor":"pointer","padding":"0 20px","margin":"0 10px","outline":"none","color":"#769589","borderRadius":"4px","background":"#fff","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="showIndex==item.id&&userid==item.userid&&showIndex1 == -1" @click="commentDel(item.id)">删除</el-button>
					</div>
					...
					<div class="comment"  :style='{"width":"100%","padding":"0 0 0 50px"}'>
						<div class="item" :style='{"padding":"8px 0","margin":"20px 0 0 0","borderColor":"#efefef","alignItems":"center","color":"#666","background":"#fff","borderWidth":"1px 0 0 0","width":"100%","borderStyle":"solid","height":"auto"}' v-for="items in item.childs" :key="items.id" @mouseenter="commentEnter1(items.id)" @mouseleave="commentLeave1">
							...
							<div :style='{"padding":"8px","margin":"10px 0px 0px","lineHeight":"30px","fontSize":"14px","color":"#9E9E9E","borderRadius":"4px"}' v-html="items.content"></div>
							<div class="btn" :style='{"width":"100%","margin":"8px 0 0 0","alignItems":"center","justifyContent":"flex-end","display":"flex","height":"40px"}'>
								<el-button :style='{"border":"1px solid #769589","cursor":"pointer","padding":"0 20px","margin":"0 10px","outline":"none","color":"#769589","borderRadius":"4px","background":"#fff","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="showIndex==item.id&&userid==items.userid&&showIndex1==items.id" @click="commentDel(items.id)">删除</el-button>
							</div>
						</div>
					</div>
					</template>
