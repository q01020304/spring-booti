...
<div :style='{"width":"1200px","padding":"20px","margin":"10px auto 20px","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"50%","padding":"10px","margin":"0 0 10px","background":"#fff"}'  label="班级" prop="banji">
            <el-select v-model="ruleForm.banji" placeholder="请选择班级" :disabled="true  ||ro.banji" >
              <el-option
  ...
  export default {
    ...
    methods: {
      ...
      init(type) {
        ...
        this.$http.get('option/banji/banji', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
            this.banjiOptions = res.data.data;
          }
        });
