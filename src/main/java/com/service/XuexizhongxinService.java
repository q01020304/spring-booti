...
public interface XuexizhongxinService extends IService<XuexizhongxinEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<XuexizhongxinEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<XuexizhongxinEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<XuexizhongxinEntity> wrapper);
