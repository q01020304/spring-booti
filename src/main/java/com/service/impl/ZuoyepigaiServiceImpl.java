...
public class ZuoyepigaiServiceImpl extends ServiceImpl<ZuoyepigaiDao, ZuoyepigaiEntity> implements ZuoyepigaiService {
    ...
    @Override
    public List<Map<String, Object>> zuoyechengjiSectionStat(Map<String, Object> params, Wrapper<ZuoyepigaiEntity> wrapper) {
        return baseMapper.zuoyechengjiSectionStat(params, wrapper);
    }
