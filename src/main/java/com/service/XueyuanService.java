...
public interface XueyuanService extends IService<XueyuanEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<XueyuanEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<XueyuanEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<XueyuanEntity> wrapper);
